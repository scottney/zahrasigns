    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <h2 class="mt-3">
                        <div class="card rounded-pill shadow text-uppercase" id="blog_management_title_card">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 p-1">
                                                            ...
                                                            <div>
                                                                <div class="d-flex justify-content-center">
                                                                    <div class="border border mt-4" id="preview_main_faatured_image"  data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                                                    data-bs-title="Preview the blog featured image here"></div>
                                                                </div>
