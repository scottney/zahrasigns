            ...
            <form action="" method="POST" role="form" accept-charset="UTF-8" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 col-xxl-8 p-3">
                        <textarea name="blog_body" class="form-control @error('blog_body') is-invalid @enderror p-1" id="input_blog_body" autofocus></textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row pt-3">
                                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 p-1">
                                        ...
                                        <input type="time" name="blog_publish_time" class="form-control @error('blog_publish_time') is-invalid @enderror border border-dark rounded-pill p-1" id="input_blog_publish_time" :value="old('blog_publish_time')" placeholder="12:30 P.M" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="The blog publish time is the set time the system will automatically publish the blog to the public for reading/viewing" autofocus>
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 p-1">
                                        ...
                                        <input type="date" name="blog_publish_date" class="form-control @error('blog_publish_date') is-invalid @enderror border border-dark rounded-pill p-1" id="input_blog_publish_date" :value="old('blog_publish_date')" placeholder="20/12/2023" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="The blog publish date is the set date the system will automatically publish the blog to the public for reading/viewing" autofocus>
                                ...
                                <div class="row pt-3">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 p-1">
                                        ...
                                        <textarea name="blog_tags" class="form-control @error('blog_tags') is-invalid @enderror border border-dark rounded p-1" id="input_blog_tags" :value="old('blog_tags')" placeholder="design, 3D modelling, signage ...." data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Tags in blogs are labels or keywords that are assigned to a blog post to help categorize and organize the content. 
                                                                They are usually located at the bottom of a blog post and can be clicked on to display other posts that have been assigned the same tag." rows="3" autofocus></textarea>
                                ...
                                <div class="row pt-3">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 p-1">
                                        ...
                                        <input type="checkbox" name="blog_is_featured" class="form-control @error('blog_is_featured') is-invalid @enderror border border-dark rounded-circle p-1" id="input_blog_is_featured" :value="old('blog_is_featured')" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Indicates whether a 
                                ...
                                <div class="row pt-3">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 p-1">
                                        ...
                                        <select name="blog_status" class="form-control @error('blog_status') is-invalid @enderror border border-dark rounded-pill p-1" id="input_blog_status" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Indicates the current status of the blog on publish.
                                                                ...
                                                                visible to the public. The status 'SYSTEM PUBLISH' means the blog will be created but publication will be done by the system on a set date and a set time" autofocus>
                                ...
                                <div class="row pt-3">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 p-1">
                                        ...
                                        <input type="text" name="meta_title" class="form-control @error('meta_title') is-invalid @enderror border border-dark rounded-pill p-1" id="input_meta_title" :value="old('meta_title')" placeholder="Signage In Africa" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="The meta title is the 
                                ...
                                <div class="row pt-3">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 p-1">
                                        ...
                                        <textarea name="meta_description" class="form-control @error('meta_description') is-invalid @enderror border border-dark rounded p-1" id="input_meta_description" :value="old('meta_description')" placeholder="3D signage and modelling across africa is greatly growing." data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="The meta description is a brief summary of a blog post that provides more information about the content and is 
                ...
                <div class="row pt-1">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 p-3">
                        <button type="submit" class="btn btn-primary float-end" id="createBlogPostButton" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Save the information provided"><span>Create Blog Post</span></button>
                    </div>
                </div>
            </form>
        </div>
